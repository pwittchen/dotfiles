...
alias monitor_laptop_off="xrandr --output eDP-1 --off"
alias monitor_reset="xrandr --auto"
alias wall_reload="feh --bg-scale ~/Pictures/wallpapers/mountains/bw-mountain-clouds.jpg"
